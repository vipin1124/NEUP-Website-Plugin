...
{	?>
	...
	<p>Time1<input class="form-control" name="time1" type="datetime-local" id="time_post1" value="<?php echo date("Y-m-d H:i:s", $time1) ?>"></p>
	...
	<p>Time2<input class="form-control" name="time2" type="datetime-local" id="time_post2" value="<?php echo date("Y-m-d H:i:s", $time1) ?>"></p>
	...
	<p>Time3<input class="form-control" name="time3" type="datetime-local" id="time_post3" value="<?php echo date("Y-m-d H:i:s", $time1)?>"></p>
